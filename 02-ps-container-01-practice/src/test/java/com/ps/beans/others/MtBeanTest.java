...
public class MtBeanTest {
    ...
    public void testConfig() {
        ...
        ApplicationContext ctx = new ClassPathXmlApplicationContext("classpath:spring/others/sample-config-01.xml",
                                                                    "classpath:spring/others/beans.xml",
                                                                    "classpath:spring/others/collectionHolder.xml",
                                                                    "classpath:spring/others/configurer.xml",
                                                                    "classpath:spring/others/factory.xml");

        //or "classpath:spring/others/*.xml"
